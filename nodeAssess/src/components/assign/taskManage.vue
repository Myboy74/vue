<template>
  <div class="y_list">
    ...
    <searchList @searchEvent="searchEvent"></searchList>
    <list :ySearch="searchList"  ref="listFun" :ycz="true" @infoEvent="infoEvent" @infoNewEvent="infoNewEvent" @changeEvent="changeEvent"></list>
