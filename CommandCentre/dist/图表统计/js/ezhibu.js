$(function(){
    ...
    chart14 = sessionStorage.getItem('chart14')
    chart15 = sessionStorage.getItem('chart15')
    if(chart01==1){
    ...
    if(chart09==9){
        ...
        if(chart14==14){
            $('.nav ul li').eq(13).addClass('active');
            $('.chart').eq(13).stop(true,true).show().siblings('.chart').hide()
            sessionStorage.removeItem("chart14"); 
                }
        if(chart15==15){
            $('.nav ul li').eq(14).addClass('active');
            $('.chart').eq(14).stop(true,true).show().siblings('.chart').hide()
            sessionStorage.removeItem("chart15"); 
                }
        ...
        function echart7(){
            ...
            option = {
                ...
                legend: {
                    ...
                    data: ['党员教育', '基本理论', '扩大民族','批评','发展党员','党员处理','有益活动']
                },
                xAxis: {
                    show: true,
                    type: 'category',
...
$(function(){
    ...
    $(function(){
        ...
        $(function(){
            ...
            function echart13(){
                var chart = echarts.init(document.getElementById('echart13'));
                option = {
                    title: {
                        text: '本月组织生活参与人次',
                        textStyle: {
              ...
              function echart14(){
                var chart = echarts.init(document.getElementById('echart14'));
                option = {
                    title: {
                        text: '本月组织生活参与人数',
                        textStyle: {
