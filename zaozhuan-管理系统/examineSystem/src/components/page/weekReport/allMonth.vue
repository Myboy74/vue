    ...
    <div class="f_tab">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>本月月报查看</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
    ...
    export default {
        ...
        methods:{
            ...
            getMonthAll(val) {
                ...
                postAjax("month/queryCurrentMonthAudited",data1).then(res => {
            ...
            getMonthCompleted(val){  //本周已完成工作
                let data1=qs.stringify(val);
                postAjax("month/queryCurrentFinishMonthAudited",data1).then(res => {
                    if(res.data.data.length==0){
                        this.lockWord=true;
            ...
            getMonthNoCompleted(val){//本周未完成工作
                let data1=qs.stringify(val);
                postAjax("month/queryCurrentNotFinishMonthAudited",data1).then(res => {
                    if(res.data.data.length==0){
