    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item style="text-align:left">修改计划</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div class="periodBox" :key="index" v-for="(elem,index) in periodArray">
            ...
            <div style="float:left">
             ...
             <el-input type="textarea" v-model="elem.completionCriteria" :autosize="{ minRows: 3, maxRows: 4}" style="width:100%;display:inline-block;margin-bottom:10px"></el-input>
            <el-input type="textarea" v-model="elem.periodContent" :autosize="{ minRows: 5, maxRows: 6}" style="width:100%"></el-input>
        ...
        <el-button type="primary" @click="saveTaskPlan" v-if="data.planState=='02'||data.planState=='03'||data.planState=='04'||data.planState=='05'">修改计划</el-button>
    ...
    export default {
        ...
        methods: {
             ...
             periodInfo(){
                ...
                let _this=this
                 postAjax("period/getPeriodInfoByPlanId",planobj).then(res => {
                    if (res.data.code == 200) {
                        if(this.data.planState=="02"||this.data.planState=="03"||this.data.planState=="04"||this.data.planState=="05"){
            ...
            getAjax("attachment/queryAttachmentList", {
                ...
                if (res.data.code == 200&&this.data.planState=="02"||this.data.planState=="03"||this.data.planState=="04"||this.data.planState=="05") {
                let _this=this;
                let ourl= localStorage.getItem('url')
                res.data.data.forEach(function(item){
